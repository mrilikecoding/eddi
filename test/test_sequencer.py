...
class TestSequencer(unittest.TestCase):
    """
    Here goes an integration test between the Sequencer and Spatial Light Controller
    ...
    Finally the next value in the sequencer queue is sent back to the main Lumi class where
    output devices are sent the new values
    """
